							...
							<div className="row">
								<main className="col-md-9">
									...
									<tr>
										<td>
											<figure className="itemside">
												<div className="aside"><img src="images/items/1.jpg" alt="" className="img-sm"/></div>
									...
									<tr>
										<td>
											<figure className="itemside">
												<div className="aside"><img src="images/items/2.jpg" alt="" className="img-sm"/></div>
												<figcaption className="info">
									...
									<tr>
										<td>
											<figure className="itemside">
												...
												<figcaption className="info">
													<Link to="/" className="title text-dark">Another name of some product goes just here as a demo text </Link>
